...
ALTER TABLE invoice ADD CONSTRAINT invoice_pkv1 PRIMARY KEY ( invoice_id );
...
ALTER TABLE invoice ADD CONSTRAINT invoice_pk UNIQUE ( invoice_id );

ALTER TABLE invoice ADD CONSTRAINT invoice_nkv1 UNIQUE ( vet_id,
                                                         animal_id );
...
ALTER TABLE service_rec ADD CONSTRAINT service_rec_pkv1 PRIMARY KEY ( service_req_id );
...
ALTER TABLE service_rec ADD CONSTRAINT service_rec_pk UNIQUE ( service_req_id );

ALTER TABLE service_rec ADD CONSTRAINT service_req_nkv1 UNIQUE ( service_code );
