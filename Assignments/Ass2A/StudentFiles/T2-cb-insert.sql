...
Insert into BREEDING_EVENT (BREVENT_ID,BREVENT_DATE,MOTHER_ID,FATHER_ID) values (01,TO_DATE('2020-01-02', 'YYYY-MM-DD'),11,10);

Insert into BREEDING_EVENT (BREVENT_ID,BREVENT_DATE,MOTHER_ID,FATHER_ID) values (02,TO_DATE('2020-01-03', 'YYYY-MM-DD'),13,12);
...
Insert into BREEDING_EVENT (BREVENT_ID,BREVENT_DATE,MOTHER_ID,FATHER_ID) values (03,TO_DATE('2020-12-12', 'YYYY-MM-DD'),16,14);
...
Insert into BREEDING_EVENT (BREVENT_ID,BREVENT_DATE,MOTHER_ID,FATHER_ID) values (04,TO_DATE('2020-12-20', 'YYYY-MM-DD'),18,17);
